        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <StarRating 
                rating={formData.detailedRating?.professionalism || 5}
                interactive={true}
                onChange={(rating) =>
                  setFormData({
                    ...formData,
            ...
            <div>
              ...
              <StarRating 
                rating={formData.detailedRating?.responseTime || 5}
                interactive={true}
                onChange={(rating) =>
                  setFormData({
                    ...formData,
            ...
            <div>
              ...
              <StarRating 
                rating={formData.detailedRating?.helpfulness || 5}
                interactive={true}
                onChange={(rating) =>
                  setFormData({
                    ...formData,
            ...
            <div>
              ...
              <StarRating 
                rating={formData.detailedRating?.communication || 5}
                interactive={true}
                onChange={(rating) =>
                  setFormData({
                    ...formData,
            ...
            <div>
              ...
              <StarRating 
                rating={formData.detailedRating?.problemResolution || 5}
                interactive={true}
                onChange={(rating) =>
                  setFormData({
                    ...formData,
