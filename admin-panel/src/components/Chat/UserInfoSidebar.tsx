...
import { X, User, Phone, Mail, Calendar, Clock, Tag, Shield, FileText, History } from 'lucide-react';
...
function UserInfoSidebar({ isOpen, onClose, selectedUser, isMobile }: UserInfoSidebarProps) {
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-semibold text-foreground">
                      {selectedUser.profile?.fullName || selectedUser.profile?.username || 'Пользователь'}
                    </h4>
              ...
              <CardContent className="p-4 pt-0 space-y-3">
                ...
                {selectedUser.profile?.username && (
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm">@{selectedUser.profile.username}</span>
                  </div>
                )}
              </CardContent>
            </Card>
